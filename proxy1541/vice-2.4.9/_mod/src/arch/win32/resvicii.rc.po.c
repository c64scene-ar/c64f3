...
STRINGTABLE
BEGIN
    IDS_VICII_CAPTION       N_("VIC-II settings")
    IDS_VICII_BORDERSGROUP  N_("Border mode")
    IDS_VICII_NORMALBORDERS N_("Normal borders")
    IDS_VICII_FULLBORDERS   N_("Full borders")
    IDS_VICII_DEBUGBORDERS  N_("Debug borders")
    IDS_VICII_NOBORDERS     N_("No borders")
    IDS_VICII_SPRITEGROUP   N_("Sprite Collisions")
    IDS_VICII_SPRITECOLL    N_("Sprite-sprite collisions")
    IDS_VICII_BACKCOLL      N_("Sprite-background collisions")
    IDS_VICII_LUMINANCE     N_("New luminances")
...
BEGIN
    ...
    IDS_VICII_SPRITEGROUP   "Colisión de Sprites"
...
BEGIN
    IDS_VICII_CAPTION       "Paramètres VIC-II"
    IDS_VICII_BORDERSGROUP  "Mode Bordure"
    IDS_VICII_NORMALBORDERS "Bordures normales"
    IDS_VICII_FULLBORDERS   "Bordures complètes"
    IDS_VICII_DEBUGBORDERS  "Bordures de déboguage"
    ...
    IDS_VICII_BACKCOLL      "Collisions sprite-arrière-plan"
    IDS_VICII_LUMINANCE     "Nouvelles luminescences"
    IDS_VICII_MODEL         "Modèle VIC-II"
    IDS_GLUE_LOGIC          "Glue logic"
    IDS_DISCRETE            "Discrète"
    IDS_CUSTOM_IC           "IC Personnalisé"
END
...
BEGIN
    IDS_VICII_CAPTION       "VIC-II beállításai"
    IDS_VICII_BORDERSGROUP  "Keret mód"
    ...
    IDS_VICII_SPRITEGROUP   "Sprite ütközések"
...
BEGIN
    ...
    IDS_VICII_BORDERSGROUP  "Modalità del bordo"
...
BEGIN
    IDS_VICII_CAPTION       "VIC-II ¼³Á¤"
    IDS_VICII_BORDERSGROUP  "º¸´õ ¸ðµå"
    IDS_VICII_NORMALBORDERS "Normal borders"
    IDS_VICII_FULLBORDERS   "Full borders"
    IDS_VICII_DEBUGBORDERS  "Debug borders"
    IDS_VICII_NOBORDERS     "No borders"
    IDS_VICII_SPRITEGROUP   "Sprite Collisions"
    IDS_VICII_SPRITECOLL    "½ºÇÁ¶óÀÌÆ®-½ºÇÁ¶óÀÌÆ® Ãæµ¹"
    IDS_VICII_BACKCOLL      "½ºÇÁ¶óÀÌÆ®-¹è°æ Ãæµ¹"
    IDS_VICII_LUMINANCE     "¼¼·Î¿î ¹à±â"
    IDS_VICII_MODEL         "VIC-II ¸ðµ¨"
    IDS_GLUE_LOGIC          "±Û·ç ·ÎÁ÷"
    IDS_DISCRETE            "´Ù¸¥"
    IDS_CUSTOM_IC           "Ä¿½ºÅÒ IC"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
    ...
    IDS_VICII_SPRITEGROUP   "Kolizje duszków"
    IDS_VICII_SPRITECOLL    "Kolizje duszków"
    IDS_VICII_BACKCOLL      "Kolizje duszków z t³em"
...
BEGIN
    IDS_VICII_CAPTION       "½ÐáâàÞÙÚØ VIC-II"
...
BEGIN
    IDS_VICII_CAPTION       "VIC-II-inställningar"
    IDS_VICII_BORDERSGROUP  "Ramläge"
    IDS_VICII_NORMALBORDERS "Vanliga ramar"
    IDS_VICII_FULLBORDERS   "Fullständinga ramar"
    IDS_VICII_DEBUGBORDERS  "Felsökningsramar"
...
BEGIN
    IDS_VICII_CAPTION       "VIC-II ayarlarý"
    IDS_VICII_BORDERSGROUP  "Çerçeve modu"
    IDS_VICII_NORMALBORDERS "Normal çerçeve"
    IDS_VICII_FULLBORDERS   "Tam çerçeve"
    IDS_VICII_DEBUGBORDERS  "Hata ayýklama çerçevesi"
    IDS_VICII_NOBORDERS     "Çerçeve yok"
    IDS_VICII_SPRITEGROUP   "Yaratýk Çarpýþmalarý"
    IDS_VICII_SPRITECOLL    "Yartýk-yaratýk çarpýþmalarý"
    IDS_VICII_BACKCOLL      "Yaratýk-arkaplan çarpýþmalarý"
    IDS_VICII_LUMINANCE     "Yeni parlaklýklar"
    IDS_VICII_MODEL         "VIC-II modeli"
    IDS_GLUE_LOGIC          "Glue logic"
    IDS_DISCRETE            "Baðlantýyý kes"
    IDS_CUSTOM_IC           "Özel IC"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
