...
BEGIN
  IDS_SIDCART_ENABLE                         "Aktivér SID-cartridget"
  ...
  IDS_DIGIBLASTER                            "Aktivér digiblaster-tilføjelse"
END
...
BEGIN
  ...
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "HardSID Geräte Auswahl"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Haupt Gerät"
...
BEGIN
  ...
  IDS_SIDCART_ADDRESS_LABEL                  "Dirección SID"
  IDS_SIDCART_CLOCK_LABEL                    "Reloj SID"
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "Selección periférico HardSID"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Periférico principal"
...
BEGIN
  ...
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "Sélection des périphériques HardSID"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Périphérique principal"
...
BEGIN
  ...
  IDS_SIDCART_ADDRESS_LABEL                  "SID cím"
  IDS_SIDCART_CLOCK_LABEL                    "SID órajel"
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "HardSID eszköz kiválasztása"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Fõ eszköz"
  IDS_DIGIBLASTER                            "Digiblaster engedélyezése"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
...
BEGIN
  IDS_SIDCART_ENABLE                         "Enable the SID cartridge"
  IDS_SIDCART_ADDRESS_LABEL                  "SID ÁÖ¼Ò"
  IDS_SIDCART_CLOCK_LABEL                    "SID Å¬¶ô"
...
BEGIN
  ...
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "Wybór urz±dzenia HardSID"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "G³ówne urz±dzenie"
...
BEGIN
  IDS_SIDCART_ENABLE                         "Enable the SID cartridge"
  IDS_SIDCART_ADDRESS_LABEL                  "°ÔàÕá SID"
  IDS_SIDCART_CLOCK_LABEL                    "SID ÒàÕÜï"
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "HardSID device selection"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Main device"
  IDS_DIGIBLASTER                            "Enable the digiblaster add-on"
END
...
BEGIN
  ...
  IDS_DIGIBLASTER                            "Aktivera digiblaster-tillägg"
END
...
BEGIN
  IDS_SIDCART_ENABLE                         "SID kartuþunu aktif et"
  IDS_SIDCART_ADDRESS_LABEL                  "SID adresi"
  IDS_SIDCART_CLOCK_LABEL                    "SID saati"
  IDS_SIDCART_HARDSID_DEVICE_SELECTION_LABEL "HardSID aygýt seçimi"
  IDS_SIDCART_HARDSID_MAIN_DEVICE_LABEL      "Ana aygýt"
