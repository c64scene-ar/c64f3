...
BEGIN
  IDS_SELECT_FILE_ISEPIC  "Vælg fil for ISEPIC"
  IDS_ISEPIC_CAPTION      "ISEPIC-indstillinger"
  IDS_ISEPIC_ENABLE       "Aktivér ISEPIC-cartridge"
  IDS_ISEPIC_SWITCH       "ISEPIC-kontakt"
  IDS_ISEPIC_WRITE_ENABLE "Gem ISEPIC image ved ændringer"
...
BEGIN
  IDS_SELECT_FILE_ISEPIC  "Datei für ISEPIC auswählen"
  IDS_ISEPIC_CAPTION      "ISEPIC Einstellungen"
  IDS_ISEPIC_ENABLE       "ISEPIC Modul aktivieren"
  IDS_ISEPIC_SWITCH       "ISEPIC Schalter"
  IDS_ISEPIC_WRITE_ENABLE "ISEPIC Imagedatei bei Änderung speichern"
...
BEGIN
  IDS_SELECT_FILE_ISEPIC  "Sélectionner fichier pour ISEPIC"
  IDS_ISEPIC_CAPTION      "Paramètres ISEPIC"
  IDS_ISEPIC_ENABLE       "Activer la cartouche ISEPIC"
  IDS_ISEPIC_SWITCH       "Paramètres d'interrupteur ISEPIC"
  IDS_ISEPIC_WRITE_ENABLE "Enregistrer l'image ISEPIC lorsque modifiée"
...
BEGIN
  IDS_SELECT_FILE_ISEPIC  "Välj fil för ISEPIC"
  IDS_ISEPIC_CAPTION      "ISEPIC-inställningar"
  IDS_ISEPIC_ENABLE       "Aktivera ISEPIC-modul"
  IDS_ISEPIC_SWITCH       "ISEPIC-omkopplare"
  IDS_ISEPIC_WRITE_ENABLE "Spara ISEPIC-avbildning vid ändringar"
  IDS_ISEPIC_FILE_LABEL   "ISEPIC-fil"
END
...
BEGIN
  IDS_SELECT_FILE_ISEPIC  "ISEPIC için dosya seçin"
  IDS_ISEPIC_CAPTION      "ISEPIC ayarlarý"
  IDS_ISEPIC_ENABLE       "ISEPIC kartuþunu aktif et"
  IDS_ISEPIC_SWITCH       "ISEPIC anahtarý"
  IDS_ISEPIC_WRITE_ENABLE "ISEPIC imajý deðiþtiðinde kaydet"
  IDS_ISEPIC_FILE_LABEL   "ISEPIC dosyasý"
END
#ifndef WINDRES_CP_IGNORE
#pragma code_page(28591)
#endif
